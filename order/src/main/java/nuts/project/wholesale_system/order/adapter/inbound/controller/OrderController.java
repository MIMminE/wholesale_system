...
public class OrderController {
    ...
    /**
     * @param orderRequest About Requesting Order Creation
    ...
    public ResponseEntity<CreateOrderResponse> createOrder(@RequestBody @Valid CreateOrderRequest orderRequest,
    ...
    public ResponseEntity<GetOrderByOrderIdResponse> getOrder(@PathVariable("orderId") String orderId) {
