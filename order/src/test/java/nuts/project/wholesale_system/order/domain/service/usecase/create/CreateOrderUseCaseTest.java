...
//        PaymentResponse paymentResponse = new PaymentResponse(accountId, "test", UUID.randomUUID().toString(), 10000);
//        BDDMockito.given(paymentService.requestPayment(any(PaymentCreateRequest.class))).willReturn(paymentResponse);
//
//        // when
